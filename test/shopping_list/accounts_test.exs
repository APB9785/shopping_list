defmodule ShoppingList.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates name and password when given" do
      {:error, changeset} = Accounts.register_user(%{name: "x", password: "x"})
  ...
  describe "apply_user_name/3" do
    ...
    test "validates name", %{user: user} do
      {:error, changeset} = Accounts.apply_user_name(user, valid_user_password(), %{name: "x"})
    ...
    test "validates current password", %{user: user} do
      {:error, changeset} = Accounts.apply_user_name(user, "invalid", %{name: unique_user_name()})
